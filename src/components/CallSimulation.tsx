...
const CallSimulation = ({ onClose }: CallSimulationProps) => {
  ...
  const handleThreatDetected = (threatLevel: number, details: any) => {
              ...
              <div className="flex-1 flex flex-col items-center justify-center space-y-8">
                ...
                <div className="bg-blue-500/20 border border-blue-400 rounded-lg p-3">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-blue-200">Real-time voice analysis active...</span>
                  </div>
                </div>
                
                {/* Embedded Voice Analyzer */}
                <div className="max-h-48 overflow-y-auto">
                  <VoiceAnalyzer 
                    isCallActive={voiceAnalysisEnabled}
